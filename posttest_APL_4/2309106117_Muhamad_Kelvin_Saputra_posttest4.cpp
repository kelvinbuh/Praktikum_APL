...
void tambahFighter() {
    if (numfighters >= max_fighters) {
        ...
        cout << "masukan jumlah kemenangan: ";
        cin >> fighters[numfighters].stats.wins;
        cout << "masukan jumlah kekalahan: ";
        cin >> fighters[numfighters].stats.losses;
        numfighters++;
...
void tampilkanFighter(int index = 0) {
    ...
    cout << "Stats:" << endl;
    cout << "Wins: " << fighters[index].stats.wins << endl;
    cout << "Losses: " << fighters[index].stats.losses << endl;
